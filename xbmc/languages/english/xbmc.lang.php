...
$l['postbit_reputation_button'] = 'Thank user';
...
$l['agreement_4'] = "Read the <a href=\"http://kodi.wiki/view/Forum_rules\" target=\"_blank\">Forum Rules</a>, <u>especially the part concerning piracy</u>. The most common reason for posts from newly signed up users to be removed is a request for support involving add-on's and/or add-on repositories on which discussion is banned. A list of banned add-ons is included in the Forum rules. This is not a comprehensive list, so even though a add-on may not be listed it may still be in violation of our Piracy Policy. Do not ask how to obtain copyrighted video on our forums.";
$l['agreement_5'] = "By continuing with the sign up process you agree to have read both the Forum Rules and the rules specified above.";
?>